...
import { StyleSheet, Text, Button, TextInput, SafeAreaView, Dimensions, TouchableOpacity } from 'react-native';
...
const App = ({ navigation }) => {
  ...
  />
    ...
    <TouchableOpacity onPress={() => navigation.navigate('Appliance')}>
      <Text style={styleSheet.text}>View Appliance Usage</Text>
        </TouchableOpacity>
